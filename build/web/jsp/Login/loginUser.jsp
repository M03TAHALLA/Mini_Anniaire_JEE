            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="/JEEProjet/images/user.png" alt="sing up image"></figure>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Login <span style="color:red">user</span></h2>
                        <form action="/JEEProjet/LoginUserServlet" method="post">
                        ...
                        <br><a href="/JEEProjet/jsp/SignUP/SignUp.jsp" name="signup" id="signin"  value="Sign Up">Sign Up</a>
                    </div>
                </div>
            </div>
        </section>
