...
<script>
    ...
    <h1>Recherche Département <i class="fa fa-building"></i>  </h1>
    <div class="container">
        <div class="cta-form">
            <h2 style="font-weight: bold;">Informations : </h2>
            <p>Tu peux Chercher sur un Departement Par Nom Departement</p>
        </div>
        
        <form action="/JEEProjet/RechDepartement" method="post" class="form">
