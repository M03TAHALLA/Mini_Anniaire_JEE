...
<h2 style="text-align: center;">Liste Département <i class="fa fa-building"></i></h2>
...
<!-- HTML !-->
<a id="ajouter" style="" class="button-3" href="/JEEProjet/jsp/formAddDepartement.jsp" role="button">Ajouter Nouveau Departement <i class="fa fa-building"></i> + </a>
    ...
    %>
            <tr>
                ...
                <td style="text-align: center ;text-transform: uppercase; "><a href="/JEEProjet/SupDepartement?NomDepartement=<%= rs.getString(1) %>"><i class="material-icons" style="font-size:30px;color:red">delete</i></a></td>
                <td style="text-align: center ;text-transform: uppercase; "><a href="/JEEProjet/jsp/admin/ModifDepartement.jsp?NomDepartement=<%= rs.getString(1) %>"><i class="fa fa-edit" style="font-size:30px;color:blue"></i></a></td>
