...
<html>
<head>
    <title>Rechercher une Fillière</title>
 <meta charset="utf-8" />
...
<script>
    ...
    <h1>Formulaire  Sur Fillière <i class="fa fa-crosshairs"></i>  </h1>
    <div class="container">
        <div class="cta-form">
            <h2 style="font-weight: bold;">Informations : </h2>
            <p>Tu peux Chercher sur un Fillière </p>
        </div>
        
        <form action="/JEEProjet/RechFilliere" method="post" class="form">
