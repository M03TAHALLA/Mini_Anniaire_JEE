 ...
 */
@WebServlet(name = "SupEtud", urlPatterns = {"/SupEtud"})
public class SupEtud extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            PreparedStatement ps = con.prepareStatement("DELETE  FROM etudiants WHERE CNE=?");
            ps.setInt(1, CNE);
            ps.executeUpdate();
            
            PrintWriter out = response.getWriter();
            
            request.setAttribute("msg", "Etudiant Suprimmer Avec Succes");
